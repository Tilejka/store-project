# python manage.py test users.tests.UserRegistrationViewTestCase
...
class UserRegistrationViewTestCase(TestCase):
    ...
    def setUp(self):
        self.data = {
            'first_name': 'Loppa', 'last_name': 'Poppa',
            'username': 'tilejka', 'email': 'Loppa@gmail.com',
            'password1': 'Django123', 'password2': 'Django123',
        }
